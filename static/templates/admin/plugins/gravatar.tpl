<form role="form" class="knuddels-settings">
	<div class="row">
		<div class="col-sm-2 col-xs-12 settings-header">Knuddels</div>
		<div class="col-sm-10 col-xs-12">
			<div class="form-group">
				<label for="default" class="mdl-switch mdl-js-switch mdl-js-ripple-effect">
					...
					<span class="mdl-switch__label">Use Knuddels as default user picture</span>
				</label>
			</div>
			<div class="checkbox">
				<label for="force" class="mdl-switch mdl-js-switch mdl-js-ripple-effect">
					...
					<span class="mdl-switch__label">Force all users to use Knuddels</span>
				</label>
			</div>
		</div>
	</div>
